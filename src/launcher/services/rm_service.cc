...
Genode::Session_capability Rm_Service::session(const char *args, Genode::Affinity const &)
{
...
void Rm_Service::upgrade(Genode::Session_capability, const char *args)
{

}

void Rm_Service::close(Genode::Session_capability session)
{
